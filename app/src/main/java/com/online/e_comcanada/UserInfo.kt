...
class UserInfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_logout = findViewById(R.id.Next)
        ...
        btn_logout.setOnClickListener {
            Toast.makeText(this@UserInfo, "Navigate to Home page", Toast.LENGTH_SHORT).show()
            startActivity(Intent(this@UserInfo, HomePage::class.java))
        }
